    ...
    <section className="h-[2311px]">
      <div className="container h-full py-[250px]">
        ...
        <div className="mb-[150px] flex justify-between">
          ...
          <div className="w-[510px]">
            <img src="/images/remittance_example.png" alt="consumption" />
          </div>
        </div>
        <div className="mb-[150px] flex justify-between">
          <div className="w-[510px]">
            <img src="/images/warning_alert.png" alt="warning_alert" />
          </div>
          <div className="w-[510px]">
            <h2 className="item-center mb-[10px] flex gap-1 text-[20px] leading-[1.4] font-[600] text-[#3182f6]">
              <div className="h-[24px] w-[24px]">
        ...
        <div className="flex justify-between">
          ...
          <div className="w-[510px]">
            <img src="/images/reservation_remittance.png" alt="reservation_remittance" />
          </div>
        </div>
      </div>
    </section>
